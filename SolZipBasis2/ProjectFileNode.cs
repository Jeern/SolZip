...
{
    public class ProjectFileNode : FileNode
    {        
        public ProjectFileNode(string rootDirectory, string fileName) : base(rootDirectory, fileName) { }
        public ProjectFileNode(string rootDirectory, string fileName, FileNode parent) : base(rootDirectory, fileName, parent) { }
